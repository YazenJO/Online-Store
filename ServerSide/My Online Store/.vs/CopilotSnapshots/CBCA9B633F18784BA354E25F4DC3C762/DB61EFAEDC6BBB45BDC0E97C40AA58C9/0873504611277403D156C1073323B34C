    ...
    public class CustomersController : ControllerBase
    {
        ...
        public ActionResult<CustomerDTO> AddCustomer(CustomerDTO newCustomerDTO)
        {
            if (newCustomerDTO == null || string.IsNullOrEmpty(newCustomerDTO.Name) || 
                string.IsNullOrEmpty(newCustomerDTO.Email) || string.IsNullOrEmpty(newCustomerDTO.Username) || 
                string.IsNullOrEmpty(newCustomerDTO.Password))
            {
        ...
        {
            if (id < 1 || updatedCustomer == null || string.IsNullOrEmpty(updatedCustomer.Name) || 
                string.IsNullOrEmpty(updatedCustomer.Email) || string.IsNullOrEmpty(updatedCustomer.Username) || 
                string.IsNullOrEmpty(updatedCustomer.Password))
            {
                return BadRequest("Invalid Customer data.");
            }
        ...
        public ActionResult<bool> DoesCustomerExist(int id)
        {
            ...
            return Ok(Customer.DoesCustomerExist(id));
        }
    }
}
